...
CREATE TABLE tbl_date(
	...
	ccol timestamp(9) , --9는 초단위를 소수점이하 9자리까지 표시하겠다는 의미
...
--내일 시험에서 timestamp 타입은 date타입하고 똑같이 to_char 함수는 동일하게 사용
--그럼 to_timestamp 이런식으로 하면 되는건가요 -> 이 부분과 관련된 문제는 없습니다.
날짜 지정할댸 '2022-10-11'와 같이 동일하게하세요
